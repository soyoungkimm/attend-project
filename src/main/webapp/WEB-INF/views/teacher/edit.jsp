                ...
                <form name="form1" method="post" action="edit-action.do" enctype="multipart/form-data">
                    ...
                    <table class="table table-bordered mytable-centermiddle" style="width:100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    <input type="text" name="tel1" size="2" value="${fn:substring(teacher.tel,0,2)}" class="form-control form-control-sm" style="width:50px">-
                                    <input type="text" name="tel2" size="4" value="${fn:substring(teacher.tel,2,6)}"	class="form-control form-control-sm" style="width:50px">-
                                    <input type="text" name="tel3" size="4" value="${fn:substring(teacher.tel,6,10)}" class="form-control form-control-sm" style="width:50px">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    <input type="text" name="phone1" size="3" value="${fn:substring(teacher.phone,0,3)}" class="form-control form-control-sm" style="width:50px">-
                                    <input type="text" name="phone2" size="4" value="${fn:substring(teacher.phone,3,7)}"	class="form-control form-control-sm" style="width:50px">-
                                    <input type="text" name="phone3" size="4" value="${fn:substring(teacher.phone,7,11)}" class="form-control form-control-sm" style="width:50px">
                                </div>
                            </td>
                        </tr>
                        <tr>
