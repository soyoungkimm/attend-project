                            ...
                            <div class="card-body" style="padding:10px">
                                ...
                                <form name="form1" action="" method="post">
                                    <div class="row" style="margin-bottom:3px">
                                        ...
                                        <div class="col" align="right">
                                            <a href="st_create.do" class="btn btn-sm mycolor1">추가</a>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-bordered mytable" style="width:100%;">
                                        ...
                                        <c:forEach var="mylecture" items="${mylectureList}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="st_edit.do?id=${mylecture.id}" class="btn btn-xs btn-outline-primary">수정</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        ...
                                        <ul class="pagination pagination-sm justify-content-center">
                                            ...
                                            <c:choose>
                                                <c:when test="${pagination.curBlock > 1 }">
                                                    <li class="page-item"><a class="page-link" href="st_list.do?p=${pagination.beginPageNo- 1}">◀</a></li>
                                                </c:when>
                                                <c:otherwise>
                                            ...
                                            <c:choose>
                                                <c:when test="${pagination.curPageNo > 1 }">
                                                    <li class="page-item"><a class="page-link" href="st_list.do?p=${pagination.curPageNo - 1}">◁</a></li>
                                                </c:when>
                                                <c:otherwise>
                                                    <li class="page-item"><a class="page-link" href="">◁</a></li>
                                                </c:otherwise>
                                            ...
                                            <c:forEach var="pageNo" begin="${pagination.beginPageNo}" end="${pagination.endPageNo}">
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <li class="page-item"><a class="page-link" href="st_list.do?p=${pageNo}">${pageNo}</a></li>
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:forEach>
                                            ...
                                            <c:choose>
                                                <c:when test="${pagination.curBlock < pagination.totalBlocks }">
                                                    <li class="page-item"><a class="page-link" href="st_list.do?p=${pagination.endPageNo + 1}">▶</a></li>
                                                </c:when>
                                                <c:otherwise>
                                                    <li class="page-item"><a class="page-link" href="">▶</a></li>
                                                </c:otherwise>
