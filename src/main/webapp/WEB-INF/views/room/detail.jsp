                ...
                <form name="detail_form" method="post" action="">
                    <table class="table table-bordered mytable-centermiddle" style="width:100%;">
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    <select name="building_id" class="form-control form-control-sm" disabled>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    <select name="floor" class="form-control form-control-sm" style="width:70px" disabled>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    <input type="text" name="ho" value="${room.ho}" class="form-control form-control-sm" readonly>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    <select name="depart_id" class="form-control form-control-sm" disabled>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    <input type="text" name="name" value="${room.name}" class="form-control form-control-sm" readonly>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    <select name="kind" class="form-control form-control-sm" disabled>
                                        <c:choose>
                                            <c:when test="${room.kind == 1}">
                                                <option value='1' selected>컴퓨터실</option>
                                                <option value='2'>강의실</option>
                                            </c:when>
                                            <c:otherwise>
                                                <option value='1'>컴퓨터실</option>
                                                <option value='2' selected>강의실</option>
                                            </c:otherwise>
                                        </c:choose>
                                    </select>
                                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="form-inline">
                                    <input type="text" name="area" value="${room.area}" class="form-control form-control-sm" style="width:80px" readonly>
                                </div>
                            </td>
                        </tr>
