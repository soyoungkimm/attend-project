        ...
        <div class="card mb-3">
            ...
            <div class="card-body" style="padding:10px">
                ...
                <table class="table table-bordered table-hover mytable" style="width:100%">
                    ...
                    <tr>
                        <td><a href="detail.do?id=${building.id}">${building.name}</a></td>
                        <td>${building.floor}층</td>
                        <td>
                            <a href="edit.do?id=${building.id}" class="btn btn-xs btn-outline-primary">수정</a>
                            <a href="delete.do?id=${building.id}" class="btn btn-xs btn-outline-danger" onClick="return confirm('삭제할까요 ?');">삭제</a>
                        </td>
                    </tr>
                    </c:forEach>
                    </tbody>
