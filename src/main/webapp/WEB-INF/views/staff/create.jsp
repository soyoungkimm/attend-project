              ...
              <div class="card-body" style="padding:10px">
                ...
                <table class="table table-bordered mytable-centermiddle" style="width:100%;">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="form-inline">
                        <input type="text" name="tel1" size="2" value="02" maxlength="2" class="form-control form-control-sm" style="width:50px">-
                        <input type="text" name="tel2" size="4" value="" maxlength="4" class="form-control form-control-sm" style="width:50px">-
                        <input type="text" name="tel3" size="4" value="" maxlength="4" class="form-control form-control-sm" style="width:50px">
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="form-inline">
                        <input type="text" name="phone1" size="3" value="010" maxlength="3" class="form-control form-control-sm" style="width:50px">-
                        <input type="text" name="phone2" size="4" value="" maxlength="4"	class="form-control form-control-sm" style="width:50px">-
                        <input type="text" name="phone3" size="4" value="" maxlength="4" class="form-control form-control-sm" style="width:50px">
                      </div>
                    </td>
                  </tr>
                  <tr>
