          ...
          <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card mb-3">
              <div class="card-header mycolor3" style="padding:10px">
                <h3><i class="fa fa-table"></i> 조교정보</h3>
              </div>
                ...
                <table class="table table-bordered table-hover table-responsive-sm mytable" style="width:100%">
                  ...
                  <c:forEach items="${requestScope.staffList}" var="staff">
                    <tr>
                      ...
                      <td><a href="detail.do?id=${staff.id}">${staff.name}</a></td>
                      <td>${fn:substring(staff.tel,0,2)}-${fn:substring(staff.tel,2,6)}-${fn:substring(staff.tel,6,10)}</td>
                      <td>${fn:substring(staff.phone,0,3)}-${fn:substring(staff.phone,3,7)}-${fn:substring(staff.phone,7,11)}</td>
                      <td>${staff.email}</td>
                      <td>
                        <a href="edit.do?id=${staff.id}" class="btn btn-xs btn-outline-primary">수정</a>
                        <a href="delete.do?id=${staff.id}" class="btn btn-xs btn-outline-danger" onClick="return confirm('삭제할까요 ?');">삭제</a>
                      </td>
                    </tr>
                  </c:forEach>
